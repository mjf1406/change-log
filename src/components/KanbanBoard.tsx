...
function KanbanColumn({
    ...
    return (
        <section
            ref={setNodeRef}
            className="flex min-h-64 min-w-0 w-full flex-col overflow-hidden rounded-xl border border-border bg-muted/20"
        >
...
export function KanbanBoard({ site }: KanbanBoardProps) {
    ...
    const handleDragEnd = (event: DragEndEvent) => {
        ...
        if (!columns) {
            ...
            if (activeContainer === overContainer) {
                ...
                finalColumns[activeContainer] = arrayMove(
                    items,
                    activeIndex,
                    overIndex,
                );
                ...
                const insertIndex =
                    overIndex >= 0 ? overIndex : destItems.length;
    ...
    return (
        <>
            ...
            >
                <div className="grid min-w-0 w-full gap-4 lg:grid-cols-3">
